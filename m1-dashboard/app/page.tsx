        ...
        <table className="text-xs w-full">
          <thead>
            <tr className="bg-gray-50">
              <th className="sticky left-0 bg-gray-50 px-2 py-1.5 text-left font-medium text-gray-500 border-r">예약주</th>
              <th className="px-2 py-1.5 text-left font-medium text-gray-500 border-r">예약일</th>
          ...
          <tbody>
            {rows.map(row => {
              ...
              const weekLabel = getReservationWeek(row.date)
              return (
                <tr key={row.date} className="border-t hover:bg-gray-50">
                  <td className="sticky left-0 bg-white px-2 py-1 font-medium text-gray-500 border-r whitespace-nowrap">{weekLabel}</td>
                  <td className="px-2 py-1 font-medium text-gray-700 border-r whitespace-nowrap">{dayLabel}</td>
